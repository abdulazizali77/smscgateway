 ...
 * 
 */
public class MProcRuleFactorySmsMultiProviderImpl implements MProcRuleFactory {
    public static final String CLASS_NAME = "smsmultiproviderule";
    ...
    public MProcRule createMProcRuleInstance() {
        return new MProcRuleSmsMultiProviderImpl();
    }
}
